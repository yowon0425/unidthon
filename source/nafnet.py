...
class NAFBlock(nn.Module):
    def __init__(self, c, DW_Expand=2, FFN_Expand=2, drop_out_rate=0.5):
        super().__init__()
...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
        ...
        self.window_size = window_size
        self.max_pool = nn.MaxPool2d(2, stride=2)  # kernel_size=2, stride=2 to reduce size by half
        self.avg_pool = nn.AvgPool2d(1, stride=1)  # kernel_size=2, stride=2 to reduce size by half
        #####################################################################################################
    ...
    def forward(self, x):
        ...
        return self.avg_pool(self.max_pool((x[:, :, :H*self.upscale, :W*self.upscale])))
